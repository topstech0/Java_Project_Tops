					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<form name="profile" method="post" action="UserController">
								...
								<div class="form-group">
									<input class="input" type="text" name="email" placeholder="Email" readonly value="<%=u.getEmail()%>">
								</div>
								...
								<div class="form-group">
									<input type="submit" value="Update Profile" name="action" class="primary-btn order-submit">
								</div>								
							</form>
